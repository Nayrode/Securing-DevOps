...
- **Scan Trivi** : Analyse ciblée des configurations de l’infrastructure, notamment le service SMTP.
...
La CI de GitHub Action, avec l'utilisation des images de Trivi et Snyk, nous révèle les suivantes vulnérabilitées : 
